...
print("Limpando e inserindo dados de exemplo no banco de dados...")

# Script SQL para limpar tabelas e inserir novos dados
sql_script = """
-- Limpar tabelas (na ordem correta devido a constraints de chave estrangeira)
DELETE FROM Contrato_Venda;
DELETE FROM Contrato_Aluguel;
DELETE FROM Visita;
DELETE FROM Imovel;
DELETE FROM Endereco;
DELETE FROM Corretor;
DELETE FROM Usuario;
DELETE FROM Status_Imovel;
DELETE FROM Perfil;

-- Resetar sequências SQLite (se necessário)
