...
from ..models.models import Usuario, ContratoAluguel
from ..schemas.schemas import Usuario as UsuarioSchema, UsuarioCreate, UsuarioUpdate, UsuarioLogin
...
def read_usuarios(skip: int = 0, limit: int = 100,
    ...
    try:
        ...
        return [{"id_usuario": u.id_usuario, 
                ...
                "sexo": u.sexo,
                "login_usu": u.login_usu,
                "fk_Perfil_id": u.fk_Perfil_id} for u in usuarios]
    except Exception as e:
        raise HTTPException(
